...
// VINCI extension
+ (UIColor *)vinciBrandBlueColor {
    return [UIColor colorWithRGBHex: 0x1878EC];  // VINCI blue color
}

+ (UIColor *)vinciBrandOrangeColor {
    return [UIColor colorWithRGBHex: 0xCBB472];  // VINCI orange color
}
