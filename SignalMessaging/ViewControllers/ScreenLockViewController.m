...
- (void)loadView
{
    ...
    UIImage *image = [UIImage imageNamed:@"logoVinci4"];
    UIImageView *imageView = [UIImageView new];
    imageView.image = image;
    [edgesView addSubview:imageView];
    
    [imageView autoVCenterInSuperview];
    [imageView autoPinEdgeToSuperviewEdge:ALEdgeLeft withInset:-32.0];
    [imageView autoPinEdgeToSuperviewEdge:ALEdgeRight withInset:-30.0];
