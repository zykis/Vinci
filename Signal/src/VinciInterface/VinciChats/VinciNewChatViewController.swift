...
@objc class VinciNewChatViewController: VinciViewController {
    ...
    enum VinciContactsSection: Int {
        ...
        case sectionGlobalVinciAccounts = 5
        case sectionVinciUndefined = 6
    ...
    func defineSection(section: Int) -> VinciContactsSection {
        ...
        case VinciContactsSection.sectionNewGroup.rawValue:
            return VinciContactsSection.sectionNewGroup
        case VinciContactsSection.sectionNewChannel.rawValue:
            return VinciContactsSection.sectionNewChannel
...
extension VinciNewChatViewController : UITableViewDelegate {
...
extension VinciNewChatViewController : UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        case .sectionGlobalVinciAccounts:
            if !isSearching {
                ...
                headerView.text = "Global Contacts"
                return headerView
            }
        default:
            // here is because of numbered sections ( Contacts for example )
...
extension VinciNewChatViewController : UISearchBarDelegate {
    ...
    func searchBarShouldBeginEditing(_ searchBar: UISearchBar) -> Bool {
        ...
        if let tableView = self.searchResultsController.tableView {
...
extension VinciNewChatViewController : ContactsViewHelperDelegate {
...
extension VinciNewChatViewController : CNContactViewControllerDelegate {
...
extension VinciNewChatViewController : VinciSearchResultsViewDelegate {
