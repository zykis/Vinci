...
@objc class VNNewChatViewController: VinciViewController {
    
    let navigationBar = VinciTopMenuController(title: "New message")
    ...
    enum VNContactsSection: Int {
        ...
        case sectionNewGroup = 1
        case sectionNewChannel = 2
        case sectionVinciContactsTitle = 3
        case sectionVinciContacts = 4
        case sectionVinciUndefined = 5
    ...
    func defineSection(section: Int) -> VNContactsSection {
        ...
        case VNContactsSection.sectionNewGroup.rawValue:
            return VNContactsSection.sectionNewGroup
        case VNContactsSection.sectionNewChannel.rawValue:
            return VNContactsSection.sectionNewChannel
        case VNContactsSection.sectionVinciContactsTitle.rawValue:
            return VNContactsSection.sectionVinciContactsTitle
...
//        statusBar.backgroundColor = Theme.backgroundColor
    ...
    func updateTableContent() {
        ...
        //        if contactsViewHelper.contactsManager.isSystemContactsAuthorized {
        sectionsMap[.sectionNewGroup] = 1
        sectionsMap[.sectionNewChannel] = 1
    ...
    func newConversation(recipientId: String) {
...
extension VNNewChatViewController : UITableViewDelegate {
...
extension VNNewChatViewController : UITableViewDataSource {
    
    func numberOfSections(in tableView: UITableView) -> Int {
        var sectionsCount:Int = VNContactsSection.count - 1 // initial value = - contacts section
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        case .sectionNewGroup:
            return sectionsMap[.sectionNewGroup] ?? 0
        case .sectionNewChannel:
            return sectionsMap[.sectionNewChannel] ?? 0
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .sectionReminder:
            ...
            return cell
        case .sectionNewGroup:
            let cell = UITableViewCell(style: .default, reuseIdentifier: "newGroupCell")
            ...
            cell.imageView?.image = UIImage(named: "newGroupIcon")?.withAlignmentRectInsets(UIEdgeInsets(top: 0.0, left: 6.0, bottom: 0.0, right: 6.0))
            return cell
        case .sectionNewChannel:
            let cell = UITableViewCell(style: .default, reuseIdentifier: "newChannelCell")
            cell.textLabel?.text = "New Channel"
            cell.textLabel?.font = VinciStrings.regularFont.withSize(16.0)
            cell.textLabel?.textColor = UIColor.vinciBrandBlue
            cell.imageView?.contentMode = .center
            cell.imageView?.image = UIImage(named: "newChannelIcon")?.withAlignmentRectInsets(UIEdgeInsets(top: 0.0, left: 6.0, bottom: 0.0, right: 6.0))
            return cell
        case .sectionVinciContactsTitle:
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        switch defineSection(section: indexPath.section) {
        case .sectionNewGroup:
            let inviteFriendsViewController = VinciGroupMembersViewController()
        ...
        default:
            ...
            if section >= minContactsSection && section < maxContactsSection {
                ...
                newConversation(recipientId: vinciAccount.recipientId)
            }
        }
    }
}
...
extension VNNewChatViewController : UISearchBarDelegate {
...
extension VNNewChatViewController : ContactsViewHelperDelegate {
...
extension VNNewChatViewController : CNContactViewControllerDelegate {
...
extension VNNewChatViewController : VinciSearchResultsViewDelegate {
