...
@objc
class VinciContactsSearchResultsController: UITableViewController, BlockListCacheDelegate {
...
extension VinciContactsSearchResultsController : ContactsViewHelperDelegate {
