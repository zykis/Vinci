...
// VINCI extension
@property (nonatomic, readonly) VinciInputTextBar *inputTextView;
...
- (void)createContents
{
    ...
    // VINCI
    _inputTextView = [VinciInputTextBar new];
    ConversationInputTextView *cInputTextView = _inputTextView.inputTextView;

//    _inputTextView = [ConversationInputTextView new];
    cInputTextView.layer.cornerRadius = kMinTextViewHeight / 2.0f;
    cInputTextView.textViewToolbarDelegate = self;
    cInputTextView.font = [UIFont ows_dynamicTypeBodyFont];
    [cInputTextView setContentHuggingHorizontalLow];
...
//    UIImage *attachmentImage = [UIImage imageNamed:@"ic_circled_plus"];
    UIImage *attachmentImage = [UIImage imageNamed:@"plusAttachmentIcon"];
    ...
    [_sendButton setImage:[UIImage imageNamed:@"sendMessageIcon"] forState:UIControlStateNormal];
//    [self.sendButton
...
//    UIImage *voiceMemoIcon = [UIImage imageNamed:@"voice-memo-button"];
    UIImage *voiceMemoIcon = [UIImage imageNamed:@"plusAudioRec"];
...
// VINCI
- (void)setVinciInputTextViewDelegate:(id<VinciInputTextBarDelegate>)value {
    self.inputTextView.delegate = value;
}

- (void)updateFontSizes
{
    self.inputTextView.inputTextView.font = [UIFont ows_dynamicTypeBodyFont];
}
...
- (void)setInputTextViewDelegate:(id<ConversationInputTextViewDelegate>)value
{
    ...
    self.inputTextView.inputTextView.inputTextViewDelegate = value;
}
...
- (NSString *)messageText
{
    ...
    return self.inputTextView.inputTextView.trimmedText;
}
...
- (void)setMessageText:(NSString *_Nullable)value animated:(BOOL)isAnimated
{
    ...
    self.inputTextView.inputTextView.text = value;
...
{
    [self updateHeightWithTextView:self.inputTextView.inputTextView];
}
...
- (void)toggleDefaultKeyboard
{
    ...
    self.inputTextView.inputTextView.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
    [self.inputTextView reloadInputViews];

    self.inputTextView.inputTextView.keyboardType = UIKeyboardTypeDefault;
    [self.inputTextView reloadInputViews];
}
...
- (void)ensureShouldShowVoiceMemoButtonAnimated:(BOOL)isAnimated
{
    void (^updateBlock)(void) = ^{
        if (self.inputTextView.inputTextView.trimmedText.length > 0) {
