...
public class LoadingViewController: UIViewController {
    ...
    override public func loadView() {
        self.view = UIView()
        view.backgroundColor = UIColor.init(rgbHex: 0xF3F3F3)

        self.logoView = UIImageView(image: UIImage(named: "logoVinci4"))
...
//        logoView.autoMatch(.width, to: .width, of: view, withMultiplier: 1/3)
        logoView.autoVCenterInSuperview()
        logoView.autoPinEdge(toSuperviewEdge: .leading, withInset: -32.0)
        logoView.autoPinEdge(toSuperviewEdge: .trailing, withInset: -30.0)
