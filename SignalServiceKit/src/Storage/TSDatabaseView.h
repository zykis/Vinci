...
// VINCI extension
extern NSString *const TSGroupThreadInboxGroup;
extern NSString *const TSGroupThreadArchiveGroup;
...
// VINCI extension
extern NSString *const TSCallMessageDatabaseViewExtensionName;
extern NSString *const TSAllCallsGroup;
extern NSString *const TSMissedCallsGroup;
