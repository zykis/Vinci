...
//    super.receivedAtTimestamp = [NSDate ows_millisecondTimeStamp];
...
//        }
//        if (receivedAtDate) {
//            super.receivedAtTimestamp = [NSDate ows_millisecondsSince1970ForDate:receivedAtDate];
//        }
//    }
